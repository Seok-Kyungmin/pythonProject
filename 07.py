def solution(answers):
    ...
    student3 = [3, 3, 1, 1, 2, 2, 4, 4, 5, 5]  # 10개 / 10개씩 반복

    # 점수 결과
    # return 결과 값이 1,2,3 숫자로 학생명을 표기해서 1,2,3 수자로 Key 값으로 사용함
    ...
    for i in range(len(answers)):
        ...
        # 학생2의 찍기 답은 10개씩 반복이라, %10 연산 사용하여 답 제공
    ...
    # 학생이 3명이고, 학생벊는 1번부터 3번까지이기에 range(1,4) 선언함
    for i in range(1, 4):
        # 가장 높은 점수를 가진 학생들만 정답지에 추가하기
